...
which yields overall model confidence bounds, representing the bounds that contain the true
...
are statistically distinguishable at a given alpha level. The pointwise bounds can be obtained via the
pointwise_total.boot function.
...
pointwise_total.boot(qcboot.fit3, pointwiseref=3)
