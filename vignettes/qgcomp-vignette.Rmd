...
still well within the prediction intervals of the marginal linear model 
...
Note the prediction interval has been replaced by actual model predictions. 
...
Alexandra J. White. A quantile-based g-computation approach to addressing the effects of exposure mixtures. In progress. 
