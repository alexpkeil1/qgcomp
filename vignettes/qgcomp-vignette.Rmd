...
\[
\mathbb{E}(Y^{\mathbf{X}_q}) = g(\psi_0 + \psi_1 S_q +  \mathbf{\eta Z})
\]
...
There are nuances to this particular model form that are available in the `qgcomp` package which will be explored below.
